...
/**
 * The API, as an Express app with no opinion about how it is served.
 *
 * Exported rather than started here so the same routes can run as a long-lived process locally and
 * as a serverless function in production. `index.ts` is the process; this file is the application.
 *
